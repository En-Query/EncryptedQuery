 ...
 *
 */
public class FileReader2 implements Callable<Long> {

	private static final Logger log = LoggerFactory.getLogger(FileReader2.class);
	 ...
	 * 
	 */
	public FileReader2(Path inputDataFile,
			QueryInfo queryInfo,
