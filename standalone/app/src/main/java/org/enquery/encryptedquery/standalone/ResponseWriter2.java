...
public class ResponseWriter2 implements Callable<Integer> {

	// private static final Logger log = LoggerFactory.getLogger(ResponseWriter2.class);
	 ...
	 * 
	 */
	public ResponseWriter2(BlockingQueue<ColumnNumberAndCipherText> inputQueue,
			QueryInfo queryInfo,
			Path outputFileName) {
