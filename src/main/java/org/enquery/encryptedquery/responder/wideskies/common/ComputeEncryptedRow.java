...
public class ComputeEncryptedRow
{
  ...
  /**
   * Method to compute the encrypted row elements for a query from extracted data partitions in the form of Iterable{@link List of BigInteger * * * * }
   * <p>
   * For each row (as indicated by key = hash(selector)), iterates over the dataPartitions and calculates the column values.
   * <p>
   * Optionally uses a static LRU cache for the modular exponentiation
  ...
  /**
   * Method to compute the encrypted row elements for a query from extracted data partitions in the form of an ArrayList of BigInteger
   * <p>
   * For each row (as indicated by key = hash(selector)), iterates over the dataPartitions and calculates the column values.
   * <p>
   * Uses a static LRU cache for the modular exponentiation
