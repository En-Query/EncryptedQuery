 ...
 * <p>
 * If spark, kick off with 'spark-submit' command or integrate into other codeflows with
 * SparkLauncher
 * <p>
 * If standalone, assumes that the target data is in the local filesystem in JSON format with one
