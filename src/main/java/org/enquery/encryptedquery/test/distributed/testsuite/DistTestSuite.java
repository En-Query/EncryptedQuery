 ...
 */
package org.enquery.encryptedquery.test.distributed.testsuite;
...
import org.enquery.encryptedquery.inputformat.hadoop.json.JSONInputFormatBase;
...
import org.enquery.encryptedquery.test.distributed.DistributedTestDriver;
import org.enquery.encryptedquery.test.utils.BaseTests;
import org.enquery.encryptedquery.test.utils.Inputs;
import org.enquery.encryptedquery.test.utils.TestUtils;
      ...
      boolean isStreaming) throws Exception
  {
    ...
    if (isSpark)
    {
      ...
      Process sLauncher = new SparkLauncher().setAppResource(SystemConfiguration.getProperty("jarFile"))
          .setSparkHome(SystemConfiguration.getProperty("spark.home")).setMainClass("org.enquery.encryptedquery.responder.wideskies.ResponderDriver")
