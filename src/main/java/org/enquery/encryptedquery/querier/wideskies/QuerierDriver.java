 ...
 * <p>
 * The output will be a file containing the hits for the query, where each line corresponds to one
 * hit and is the string representation of the corresponding QueryResponseJSON object.
 * <p>
