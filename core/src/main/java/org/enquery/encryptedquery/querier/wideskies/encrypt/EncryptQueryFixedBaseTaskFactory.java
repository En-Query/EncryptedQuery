...
public class EncryptQueryFixedBaseTaskFactory implements EncryptQueryTaskFactory {
	...
	public EncryptQueryFixedBaseTaskFactory(int dataPartitionBitSize, Paillier paillier, Map<Integer, Integer> selectorQueryVecMapping, Random random) {
	...
	public BigInteger[][] getPLookupTable() {
		return pLUT;
	}

	public BigInteger[][] getQLookupTable() {
		return qLUT;
	}
	...
	public MontgomeryReduction getMontPSquared() {
		return montPSquared;
	}

	public MontgomeryReduction getMontQSquared() {
		return montQSquared;
	}
