...
public class RecordPartitioner {
	 ...
	 */
	public static List<Byte> partitionRecord(Partitioner partitioner, QueryInfo queryInfo, Map<String, Object> recordData) throws PIRException {

		QuerySchema qSchema = queryInfo.getQuerySchema();
        Boolean embedSelector = queryInfo.getEmbedSelector();
