...
public class JDBCTestBase {
	...
	public static final Map<String, String> fieldTypes = new HashMap<>();
	{
		fieldTypes.put("id", FieldTypes.INT);
		fieldTypes.put("title", FieldTypes.STRING);
		fieldTypes.put("author", FieldTypes.STRING);
		fieldTypes.put("price", FieldTypes.DOUBLE);
		fieldTypes.put("qty", FieldTypes.INT);
		fieldTypes.put("release_dt", FieldTypes.ISO8601DATE);
	}
