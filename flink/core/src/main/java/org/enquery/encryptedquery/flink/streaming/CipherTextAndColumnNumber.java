...
/**
 * A tuple of a Ciphertext and a column number, result of encrypting a column, input to the sink
 * function.
 */
public class CipherTextAndColumnNumber implements Serializable {
	 ...
	 */
	public CipherTextAndColumnNumber() {}
	...
	public String toString() {
		...
		builder.append("CipherTextAndColumnNumber [window=").append(WindowInfo.windowInfo(windowMinTimestamp, windowMaxTimestamp)).append(", col=").append(col).append(", eof=").append(isEof).append("]");
