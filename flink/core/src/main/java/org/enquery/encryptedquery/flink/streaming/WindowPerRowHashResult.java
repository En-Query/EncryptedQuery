 ...
 */
public class WindowPerRowHashResult implements Serializable {
	...
	public String toString() {
		...
		builder.append("WindowPerRowHashResult [col=").append(col).append(", windowMaxTimestamp=").append(windowMaxTimestamp).append(", rowHash=").append(rowHash).append("]");
