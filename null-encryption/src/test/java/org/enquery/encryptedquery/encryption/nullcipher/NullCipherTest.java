...
public class NullCipherTest {
	...
	class State {
		...
		public NullCipherCryptoScheme getScheme() {
			return this.scheme;
		}
		...
		public NullCipherPublicKey getPubkey() {
			return this.pub;
		}

		public NullCipherPrivateKey getPrivkey() {
			return this.priv;
		}
	}
	...
	public void initializeSchemeWithInvalidPlaintextByteSize() throws Exception {
		...
		try (NullCipherCryptoScheme scheme = new NullCipherCryptoScheme()) {
			scheme.initialize(cfg);
		}
	}
